...
import com.excilys.ebi.gatling.core.action.builder.{ ActionBuilder, CustomFunctionBuilder }
...
trait Execs[B] {
	 ...
	 */
	def exec(sessionFunction: Session => Session): B = exec(new CustomFunctionBuilder(sessionFunction, true))

...
import com.excilys.ebi.gatling.core.action.builder.{ ActionBuilder, SimpleActionBuilder }
...
trait Execs[B] {
	 ...
	 */
	def exec(sessionFunction: Session => Session): B = exec(SimpleActionBuilder(sessionFunction, true))
